GameSettings = Struct.new(:kids, :positions, :total_games, :max_mixups, :file_folder, :total_innings)
...
module Settings
  ...
  def load
    ...
    GameSettings.new(kids, positions, total_games, max_mixups, file_folder, total_innings)
  end
end
